      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="min-w-0">
            ...
            {isGoogleUser && (
              <span className="inline-flex items-center gap-1 text-[10px] bg-[#0a0a0f] border border-red-900/20 rounded-full px-2 py-0.5 mt-1 text-zinc-500">
        ...
        {activeTab === 'account' && (
          <div className="space-y-6">
            <section className="bg-[#0a0a0f] border border-red-900/15 rounded-xl p-5 sm:p-6 relative overflow-hidden">
        ...
        {activeTab === 'projects' && (
          <div className="space-y-3">
            ...
            {sessions.length === 0 ? (
              <div className="bg-[#0a0a0f] border border-red-900/15 rounded-xl p-8 text-center">
              ...
              sessions.map(s => {
                ...
                return (
                  <div key={s.id} className="bg-[#0a0a0f] border border-red-900/15 rounded-xl p-4 group hover:border-red-500/25 transition-all">
                ...
                {[
                  ...
                  <label key={opt.value}
                    className={`flex items-start gap-3 p-3 rounded-lg border cursor-pointer transition-colors
                      ${stance === opt.value ? `${opt.color} bg-[#111116]` : 'border-red-900/15 hover:border-red-900/30'}`}>
